...
package com.com.baidu.mapapi.clusterutil.clustering;
...
import com.com.baidu.mapapi.clusterutil.clustering.algo.Algorithm;
import com.com.baidu.mapapi.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm;
import com.com.baidu.mapapi.clusterutil.clustering.algo.PreCachingAlgorithmDecorator;
import com.com.baidu.mapapi.clusterutil.clustering.view.ClusterRenderer;
import com.com.baidu.mapapi.clusterutil.clustering.view.DefaultClusterRenderer;
...
public class ClusterManager<T extends ClusterItem> implements
    ...
    public void cluster() {
        ...
        try {
            if (mClusterTask==null || mMap==null)
                return;
