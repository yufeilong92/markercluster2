...
import com.com.baidu.mapapi.clusterutil.MarkerManager;
...
import com.com.baidu.mapapi.clusterutil.projection.Point;
import com.com.baidu.mapapi.clusterutil.projection.SphericalMercatorProjection;
import com.com.baidu.mapapi.clusterutil.ui.IconGenerator;
import com.com.baidu.mapapi.clusterutil.ui.SquareTextView;
import com.example.administrator.markercluster.DemoApplication;
import com.example.administrator.markercluster.R;
import com.example.administrator.markercluster.Util;
...
import static com.com.baidu.mapapi.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements
    ...
    /*显示的个数等级*/
    private static final int[] BUCKETS = {10, 20, 50, 100, 200, 500, 1000,10000};
    ...
    /*储存marker*/
    List<Point> mClustersOnScreen = new ArrayList<>();
...
//        Resources resources = DemoApplication.getContext().getResources();
//        Drawable drawable = resources.getDrawable(R.mipmap.round_icon);
//        return drawable;
//    }
...
//            }
            ...
            for (Cluster<T> c : clusters) {
                if (Util.compareLat(mMap,c.getPosition())) {
                /*是否包含这个点*/
                    boolean onScreen = visibleBounds.contains(c.getPosition());
                /*修改的条件 zoomingIn当前地图级别是否大于设定的地图级别*/
